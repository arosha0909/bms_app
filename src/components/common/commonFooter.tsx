        ...
        <footer className="py-12">
            <div className="container">
                <div className="flex flex-wrap -mx-3">
                    <div className="flex-shrink-0 w-full max-w-full mx-auto mb-2 text-center lg:flex-0 lg:w-8/12 text-sm">
                    ...
                    <div className="flex-shrink-0 w-full max-w-full mx-auto mt-2 mb-2 text-center lg:flex-0 lg:w-8/12">
                ...
                <div className="flex flex-wrap -mx-3">
                    <div className="w-8/12 max-w-full px-3 mx-auto mt-1 text-center flex-0">
                        <p className="mb-0 text-slate-400 text-xs">
                            Copyright ©
