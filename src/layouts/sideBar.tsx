        ...
        <>
            <aside className="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
                <div className="h-19.5">
                    ...
                    <span className="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Ceylon Vehicle Tracking</span>
                    </a>
                </div>
                ...
                <div className="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
                    ...
                    <li className="mt-0.5 w-full">
                        <Link className={location.pathname === RouteName.ANALYTICS ? `py-2.7 shadow-soft-xl  bg-white px-4 font-semibold text-slate-700 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg transition-colors` : `py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors`} to={RouteName.ANALYTICS}>
                            <div className={location.pathname === RouteName.ANALYTICS ? "bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5" : "shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5"}>
                    ...
                    <li className="mt-0.5 w-full">
                        <Link className={location.pathname === RouteName.VEHICLE ?`py-2.7 shadow-soft-xl  bg-white px-4 font-semibold text-slate-700 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg transition-colors` : `py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors`} to={RouteName.VEHICLE}>
                            <div className={location.pathname === RouteName.VEHICLE ? "bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5" : "shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5"}>
                            ...
                            <span className="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Vehiicles</span>
                        </Link>
                    </li>

                    <li className="mt-0.5 w-full">
                        <Link className="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" to={RouteName.VEHICLE}>
                            ...
                            <span className="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Routes</span>
                        </Link>
                    </li>
{/* 
                    <li className="mt-0.5 w-full">
                    ...
                    <li className="w-full mt-4">
                        <h6 className="pl-6 ml-2 text-xs font-bold leading-tight uppercase opacity-60">User Managments</h6>
                    </li>
                    ...
                    <li className="mt-0.5 w-full">
                        ...
                        <span className="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Drivers</span>
                        </a>
                    </li>
                    ...
                    <li className="mt-0.5 w-full">
                        ...
                        <span className="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Helpers</span>
                        </a>
                    </li>
                ...
                <div className="mx-4 ">
                    <p className="invisible hidden text-gray-800 after:bg-gradient-to-tl after:from-gray-900 after:to-cyan-400"></p>
                    ...
                    <div className="mb-7.5 absolute h-full w-full rounded-2xl bg-cover bg-center" style={{backgroundImage: `url(${getAssetPath('./assets/img/curved-images/white-curved.jpeg')})`}}></div>
                    <div className="relative z-20 flex-auto w-full p-4 text-left text-white">
                        ...
                        <a href="#" target="_blank" className="inline-block w-full px-8 py-2 mb-0 text-xs font-bold text-center text-black uppercase transition-all ease-in bg-white border-0 border-white rounded-lg shadow-soft-md bg-150 leading-pro hover:shadow-soft-2xl hover:scale-102">Chat with Us</a>
                        </div>
                    </div>
                    </div>
                    <a className="inline-block w-full bottom-7.5 left-7.5 px-6 py-3 my-4 text-xs font-bold text-center text-white uppercase align-middle transition-all ease-in border-0 rounded-lg select-none shadow-soft-md bg-150 bg-x-25 leading-pro bg-gradient-to-tl from-purple-700 to-pink-500 hover:shadow-soft-2xl hover:scale-102" href="#">Upgrade to pro</a>
                </div>
            </aside>
        </>
    )
