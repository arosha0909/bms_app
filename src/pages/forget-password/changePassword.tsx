                                ...
                                <div className="flex flex-col w-full max-w-full px-3 mx-auto md:w-6/12 lg:w-5/12 xl:w-4/12">
                                    <div className="relative flex flex-col min-w-0 mt-32 break-words bg-transparent border-0 shadow-none rounded-2xl">
                                        <div className="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                                            ...
                                            <p className="mb-0">Enter old password and new passowrd</p>
                                        </div>
                                        ...
                                        <div className="flex-auto p-6">
                                            <form onSubmit={handleSubmit(onSubmit)}>
                                                ...
                                                <div className="mb-4">
                                                    <input {...register("confirmPassword")} type="password" className="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-blue-600 focus:outline-none focus:transition-shadow" placeholder="Confim Password" aria-label="Password" aria-describedby="password-addon" />
