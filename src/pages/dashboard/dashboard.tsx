                ...
                <div className="flex-auto p-4">
                  <div className="flex flex-row -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal">Total Vehicals</p>
                        <h5 className="mb-0 font-bold">
                          18 &nbsp;
                          <span className="text-sm leading-normal font-weight-bolder text-lime-500">7</span>
                        </h5>
                      </div>
                    </div>
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-row -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal">Users</p>
                        <h5 className="mb-0 font-bold">
                          23 &nbsp;
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-row -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal">Routes</p>
                        <h5 className="mb-0 font-bold">
                          48 &nbsp;
                          <span className="text-sm leading-normal text-red-600 font-weight-bolder">0</span>
                        </h5>
                      </div>
                    </div>
                    <div className="px-3 text-right basis-1/3">
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-row -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal">Income</p>
                        <h5 className="mb-0 font-bold">
                          $103,430 &nbsp;
                  ...
                  <div className="w-full px-6 mx-auto max-w-screen-2xl rounded-xl">
                    <div className="flex flex-wrap mt-0 -mx-3">
                      ...
                      <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                        ...
                        <div className="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                          {/* <div className="duration-600 ease-soft -mt-0.38 -ml-px flex h-1.5 w-1/2 flex-col justify-center overflow-hidden 
                          whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div> */}
                        </div>
                      </div>
                    </div>
                  </div>
